  ...
  return (
    <>
      ...
      <main className="px-4 py-5 pb-safe">
        <IngredientForm userId={user.id} userIngredients={userIngredients} visibleCategories={visibleCategories} categorySuggestions={categorySuggestions} categoryConfig={categoryConfig} />
      </main>
    </>
  );
}
